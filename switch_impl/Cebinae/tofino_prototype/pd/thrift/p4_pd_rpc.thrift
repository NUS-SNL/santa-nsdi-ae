...
enum main_input_fields__field_list_1_t {
  _FIELD_LIST_1_HDR_IP_SRC_ADDR = 0,
  _FIELD_LIST_1_HDR_IP_DST_ADDR = 1,
}
...
struct main_Ingress_t_igr_tiDrop_rotate_match_spec_t {
  1: required i16 f;
  2: required i16 f_mask;
}

struct main_Ingress_t_igr_tiRotateTailq_match_spec_t {
  1: required i16 f;
}

struct main_Ingress_t_igr_tiRotateHeadq_match_spec_t {
  1: required i16 f;
}

struct main_Ingress_t_igr_tiRotateRoundTime_match_spec_t {
  1: required i16 f;
}
...
struct main_Ingress_t_igr_tiDrop_rotate_entry_desc_t {
  1: required main_Ingress_t_igr_tiDrop_rotate_match_spec_t match_spec;
  2: required bool has_mbr_hdl;
  3: required bool has_grp_hdl;
  4: required MemberHandle_t selector_grp_hdl;
  5: required MemberHandle_t action_mbr_hdl;
...
struct main_Ingress_t_igr_tiRotateTailq_entry_desc_t {
  1: required main_Ingress_t_igr_tiRotateTailq_match_spec_t match_spec;
  2: required bool has_mbr_hdl;
  3: required bool has_grp_hdl;
  4: required MemberHandle_t selector_grp_hdl;
  5: required MemberHandle_t action_mbr_hdl;
...
struct main_Ingress_t_igr_tiRotateHeadq_entry_desc_t {
  1: required main_Ingress_t_igr_tiRotateHeadq_match_spec_t match_spec;
  2: required bool has_mbr_hdl;
  3: required bool has_grp_hdl;
  4: required MemberHandle_t selector_grp_hdl;
  5: required MemberHandle_t action_mbr_hdl;
...
struct main_Ingress_t_igr_tiRotateRoundTime_entry_desc_t {
  1: required main_Ingress_t_igr_tiRotateRoundTime_match_spec_t match_spec;
  2: required bool has_mbr_hdl;
  3: required bool has_grp_hdl;
  4: required MemberHandle_t selector_grp_hdl;
  5: required MemberHandle_t action_mbr_hdl;
...
service main {
    ...
    EntryHandle_t Ingress_t_igr_tiDrop_rotate_match_spec_to_entry_hdl(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiDrop_rotate_match_spec_t match_spec, 4:i32 priority) throws (1:InvalidTableOperation ouch),
    EntryHandle_t Ingress_t_igr_tiRotateTailq_match_spec_to_entry_hdl(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiRotateTailq_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    EntryHandle_t Ingress_t_igr_tiRotateHeadq_match_spec_to_entry_hdl(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiRotateHeadq_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    EntryHandle_t Ingress_t_igr_tiRotateRoundTime_match_spec_to_entry_hdl(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiRotateRoundTime_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    ...
    EntryHandle_t Ingress_t_igr_tiDrop_rotate_table_add_with_NoAction(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiDrop_rotate_match_spec_t match_spec, 4:i32 priority) throws (1:InvalidTableOperation ouch),
    EntryHandle_t Ingress_t_igr_tiDrop_rotate_table_add_with_Ingress_t_igr_aiDrop_rotate(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiDrop_rotate_match_spec_t match_spec, 4:i32 priority) throws (1:InvalidTableOperation ouch),
    EntryHandle_t Ingress_t_igr_tiRotateTailq_table_add_with_NoAction(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiRotateTailq_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    EntryHandle_t Ingress_t_igr_tiRotateTailq_table_add_with_Ingress_t_igr_aiRotateTailq(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiRotateTailq_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    EntryHandle_t Ingress_t_igr_tiRotateHeadq_table_add_with_NoAction(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiRotateHeadq_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    EntryHandle_t Ingress_t_igr_tiRotateHeadq_table_add_with_Ingress_t_igr_aiRotateHeadq(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiRotateHeadq_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    EntryHandle_t Ingress_t_igr_tiRotateRoundTime_table_add_with_NoAction(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiRotateRoundTime_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    EntryHandle_t Ingress_t_igr_tiRotateRoundTime_table_add_with_Ingress_t_igr_aiRotateRoundTime(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiRotateRoundTime_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    ...
    void Ingress_t_igr_tiDrop_rotate_table_modify_with_NoAction(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiDrop_rotate_table_modify_with_NoAction_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiDrop_rotate_match_spec_t match_spec, 4:i32 priority) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiDrop_rotate_table_modify_with_Ingress_t_igr_aiDrop_rotate(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiDrop_rotate_table_modify_with_Ingress_t_igr_aiDrop_rotate_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiDrop_rotate_match_spec_t match_spec, 4:i32 priority) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiRotateTailq_table_modify_with_NoAction(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiRotateTailq_table_modify_with_NoAction_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiRotateTailq_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiRotateTailq_table_modify_with_Ingress_t_igr_aiRotateTailq(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiRotateTailq_table_modify_with_Ingress_t_igr_aiRotateTailq_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiRotateTailq_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiRotateHeadq_table_modify_with_NoAction(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiRotateHeadq_table_modify_with_NoAction_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiRotateHeadq_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiRotateHeadq_table_modify_with_Ingress_t_igr_aiRotateHeadq(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiRotateHeadq_table_modify_with_Ingress_t_igr_aiRotateHeadq_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiRotateHeadq_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiRotateRoundTime_table_modify_with_NoAction(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiRotateRoundTime_table_modify_with_NoAction_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiRotateRoundTime_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiRotateRoundTime_table_modify_with_Ingress_t_igr_aiRotateRoundTime(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiRotateRoundTime_table_modify_with_Ingress_t_igr_aiRotateRoundTime_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiRotateRoundTime_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
...
# //::   if action_table_hdl: continue
    void Ingress_t_igr_tiDrop_rotate_table_delete(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiDrop_rotate_table_delete_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiDrop_rotate_match_spec_t match_spec, 4:i32 priority) throws (1:InvalidTableOperation ouch),
# //::   if action_table_hdl: continue
    void Ingress_t_igr_tiRotateTailq_table_delete(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiRotateTailq_table_delete_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiRotateTailq_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
# //::   if action_table_hdl: continue
    void Ingress_t_igr_tiRotateHeadq_table_delete(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiRotateHeadq_table_delete_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiRotateHeadq_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
# //::   if action_table_hdl: continue
    void Ingress_t_igr_tiRotateRoundTime_table_delete(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void Ingress_t_igr_tiRotateRoundTime_table_delete_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:main_Ingress_t_igr_tiRotateRoundTime_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
# //::   if action_table_hdl: continue
