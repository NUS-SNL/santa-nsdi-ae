...
bfrt.mirror.cfg.entry_with_normal(sid=333, direction='BOTH', session_enable=True, ucast_egress_port=26, ucast_egress_port_valid=True, max_pkt_len=16384).push()
...
# Port shaping
RATE_IN_KBPS = 300_000   # CAIDA change 1G # 50Mbps currently
# RATE_IN_KBPS = 11_200
RECV_PORT = 24
