...
bf_status_t app_run(bf_switchd_context_t *switchd_ctx)
{
    ...
    fflush(stdout);
    std::string bfshell_cmd = BFSHELL " -b " __DIR__ "/setup_scripts/setup_tofino_santa.py";
    ...
    std::string run_pd_rpc_cmd = "env PYTHONPATH=" + customPythonPath + " SDE_INSTALL=" SDE_INSTALL " " RUN_PD_RPC " " __DIR__ "/setup_scripts/set_rate.py";
