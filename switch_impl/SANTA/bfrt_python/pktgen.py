...
ETHERTYPE = 0x0800  # used to identify pktgen pkt
...
SRC_MAC = "BF:CC:11:22:33:44"  # doesn't matter --> used to distingush different type of pks
DST_MAC = "3c:fd:fe:b7:e7:f4"
TIME_PERIOD = 2000000000    # ns; 1s=1000000000
PKTS_COUNT = 1

pkt = Ether(dst= DST_MAC, src=SRC_MAC, type=ETHERTYPE) / IP(src="10.1.1.1", dst="10.1.1.3") # Form the pkt to be written to buffer

# Add the IP header to the packet
# pkt = pkt / IP(src="10.1.1.1", dst="10.1.1.3")
